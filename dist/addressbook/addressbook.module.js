...
const addressbook_controller_1 = require("./addressbook.controller");
...
AddressbookModule = __decorate([
    (0, common_1.Module)({
        controllers: [addressbook_controller_1.AddressbookController],
        providers: [addressbook_service_1.AddressbookService]
    })
], AddressbookModule);
